...
export { ClientStateManager, DOMPatcher, EventDelegation, HintQueue, HydrationManager, Minimact, SignalRManager, TemplateRenderer, TemplateStateManager, clearComponent as clearClientComputedComponent, clearComponentContext, clearContextHookContext, computeAllForComponent, computeDependentVariables, computeVariable, createContext, Minimact as default, getAllLastValues, getDebugInfo as getClientComputedDebugInfo, getComputedVariableNames, getLastValue, hasClientComputed, registerClientComputed, setComponentContext, setContextHookContext, templateState, useAnimationFrame, useComputed, useContext, useEffect, useIdleCallback, useMacroTask, useMicroTask, usePaginatedServerTask, usePub, useRef, useServerTask, useSignalR, useState, useSub };
//# sourceMappingURL=core-r.esm.js.map
